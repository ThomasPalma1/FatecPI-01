			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact"
					 aria-selected="false">Meu saldo</a>
				</li>
				<!--<li class="nav-item">
				...
				<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
					...
					<hr/>');
			  		...
			  		<h4>Cartões cadastrados:</h4>
					   ...
					   echo(' <form action="adicionar_fundos.php" method="post">
			  		<div class="form-row">
					
						  </div>
						  <div class="form-group">
						  	
						  	 <input type="hidden" class="form-control"  name="email_usuario" id="email_usuario" style="width: 400px" value="'.$_SESSION['email'].'">
						   ...
						   <div class="input-group mb-3">
							<div class="row">
							  ...
							  <div class="col-md-4 col-xs-4">
							   ...
							   <div class="col-md-4 col-xs-4">
							  <div class="form-group">
						    <label for="inputAddress2">Saldo a ser inserido</label>
						    <input type="text" class="form-control" id="saldo" name="saldo" maxlength="16" placeholder="Adicionar fundos">
						  </div>
						</div>
						</div>
					</div>	
						<input type="submit" name="remover" value="remover"><input type="submit" value="Adicionar fundos"></input>');
               }
               else {
